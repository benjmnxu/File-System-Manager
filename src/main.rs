...
async fn main() {
    ...
    let vec = mac::fetch_file_system_with_getattrlistbulk_parallel("/");
    ...
    println!("Number of entries fetched: {}", vec.len());

    // Assuming 320 GB is a constant to display
    println!("Used Disk Space: 320 GB");
}
